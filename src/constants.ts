...
export const LOCATIONS: Location[] = [
  {
    ...
    phone: '(972) 213-0186',
    hours: 'MON, TUE, THU–SUN: 11:00 AM – 8:30 PM · WED: CLOSED',
    hoursWeekdays: 'MON, TUE, THU–SUN: 11:00 AM – 8:30 PM',
    hoursSunday: 'WEDNESDAYS: CLOSED',
    hoursWeekdaysMobileLines: ['MON, TUE, THU–SUN', '11:00 AM – 8:30 PM'],
